...
Logowanie B2B, organizacje, zespół, płatności, ustawienia marki i magazyn dokumentów zapisują dane produkcyjne. Podgląd pokazuje oryginalny PDF lub obraz, a odczytaną kwotę można zweryfikować i poprawić ręcznie. Klient może skopiować zweryfikowane dane do zwykłego przelewu; Epito nie przyjmuje środków i nie potwierdza płatności bez niezależnego potwierdzenia. Publiczne demo pozostaje odseparowane od PostgreSQL. Integracja operatora płatności, uzgadnianie wyciągów, produkcyjny moduł wiadomości, automatyczne backupy i komplet dokumentacji RODO wymagają dalszej konfiguracji przed komercyjnym uruchomieniem. Szczegóły etapów opisuje [roadmapa integracji](docs/integration-roadmap.md).
