    ...
    <section className="subpage settings-page">
      ...
      <div className="settings-layout">
        ...
        <div className="settings-content">
          ...
          <article className="settings-card"><div className="settings-card-head"><Globe2 size={21} /><div><h3>Adres portalu</h3><p>Dedykowany adres logowania dla Twojej firmy.</p></div></div><label className="domain-input"><span>https://</span><input defaultValue="client231" /><b>.epito.pl</b><button aria-label="Kopiuj adres"><Copy size={17} /></button></label><small className="field-help">Zmiana adresu wymaga ponownego zalogowania wszystkich użytkowników.</small></article>
